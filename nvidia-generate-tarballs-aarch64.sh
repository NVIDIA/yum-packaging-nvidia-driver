...
create_tarball() {
    ...
    mkdir ${KMOD_LEGACY} ${KMOD_OPEN} ${KMOD_COMMON} ${USR_64}
    ...
    for tarball in ${KMOD_OPEN} ${KMOD_LEGACY} ${KMOD_COMMON} ${USR_64} ${USR_32}; do
